        ...
        <div className="h-full overflow-auto scrollbar-thin flex justify-center items-center flex-col relative">
          <div className="flex flex-col items-center mb-1 max-w-[400px] text-center">
            <img
              ...
              className="block"
            ></img>
            <h1 className="text-4xl font-bold mb-1">Whisper</h1>
            ...
            {status === null && (
              <>
                <p className="max-w-[480px] mb-4">
                  <br />
                  You are about to load whipser speech recognition model that is
                  optimized for inference on the web. Once downloaded, the model
                  will be cached and reused when you revisit the page.
                  <br />
                  <br />
                  Everything runs directly in your browser, meaning no data is
                ...
                <div className="flex flex-col mb-2">
                  ...
                  <select
                    className="border rounded-lg p-2 mb-4 dark:bg-gray-800 dark:text-gray-200"
                    value={model}
